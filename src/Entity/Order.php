...
class Order
{
    ...
    public function getTotalWt(){
        ...
        foreach($products as $product){
            ...
            $totalTTC += ($product->getProductPrice() * $product->getProductQuantity()) * $coeff;
        }

        return $totalTTC + $this->getCarrierPrice();
    }

    //les Frais de transport pas inclus dans le calcul de la TVA
    public function getTotalTva(){
        ...
        foreach($products as $product){
            ...
            $totalTVA += ($product->getProductPrice()  * $product->getProductQuantity() )* $coeff;
        }
        return $totalTVA;
    } 
